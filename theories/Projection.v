...
From Dep Require Import NewSyntax Inductive_Linearity Predicates Substitutions Structures.
...
p \notin a -> i < size gs  -> bisim_dec (project (nth GEnd gs 0) p) (project (nth GEnd gs i) p).
Proof. 
...
Lemma fv_rproject_in : forall g p n,  n  \in (endpoint_fv (project g p)) -> n \in (gType_fv g).
Proof. 
Admitted.
(*move => g p n. rewrite project_clean_rproject fv_clean. move : g p n.
